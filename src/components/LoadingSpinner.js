...
export default function LoadingSpinner({ size = 40, className = '', color = '#FF6700' }) {
  return (
    <svg className={className} xmlns='http://www.w3.org/svg/2000' x='0px' y='0px' width={`${size}px`} height={`${size}px`} viewBox='0 0 40 40'>
